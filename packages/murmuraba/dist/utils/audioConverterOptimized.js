...
export class OptimizedAudioConverter {
     ...
     */
    async performWavConversion(blob) {
     ...
     */
    encodeWavOptimized(audioBuffer) {
     ...
     */
    async convertToMp3MainThread(blob, bitrate) {
     ...
     */
    async convertToMp3InWorker(blob, bitrate) {
...
export function getOptimizedAudioConverter() {
