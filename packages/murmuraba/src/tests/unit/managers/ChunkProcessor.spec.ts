...
describe('ChunkProcessor', () => {
  ...
  describe('Initialization', () => {
    it('should create processor with default options', () => {
      const defaultProcessor = new ChunkProcessor(
        48000,
        { chunkDuration: 1000 },
        mockLogger,
        mockMetricsManager
  ...
  describe('Options Validation', () => {
    it('should validate chunk duration', () => {
      expect(
        () => new ChunkProcessor(48000, { chunkDuration: -1000 }, mockLogger, mockMetricsManager)
      ).toThrow();

      expect(
        () => new ChunkProcessor(48000, { chunkDuration: 0 }, mockLogger, mockMetricsManager)
      ).toThrow();
    });
