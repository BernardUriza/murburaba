...
interface UseMurmubaraEngineExtendedOptions extends MurmubaraConfig {
...
interface UseMurmubaraEngineExtendedReturn {
  // State
...
/**
 * Extended Murmuraba hook with full recording and playback functionality
 */
export function useMurmubaraEngineExtended(
  options: UseMurmubaraEngineExtendedOptions = {}
): UseMurmubaraEngineExtendedReturn {
  const { 
